export default [
  ...
  // },
  {
    ...
    jobDescription: {
      description:
        "I'm working with 3D Studio solutions as UX/UI designer and Full Stack Engineer. Creating a fully new pipeline with Shotgun and many other applications and plugins.",
